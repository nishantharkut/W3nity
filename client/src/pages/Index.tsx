...
import { Briefcase, Calendar, Users, Star, TrendingUp, Zap, Shield, Globe } from 'lucide-react';
...
const Index = () => {
  ...
  const features = [
    {
      ...
      description: 'Connect with top talent and discover amazing projects in the tech space.',
      link: '/freelance',
    },
    {
      icon: Calendar,
      title: 'Tech Events',
      description: 'Join conferences, workshops, and networking events in your area.',
      link: '/events',
    },
    {
      icon: Users,
      title: 'Community Chat',
      description: 'Real-time collaboration with developers, designers, and entrepreneurs.',
      link: '/community',
    },
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Build your reputation and grow your network in the tech community.',
    },
  ];
        ...
        <div className="container mx-auto text-center relative z-10">
          <div className="animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Welcome to{' '}
              <span className="text-gradient">SparkVerse</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              The ultimate platform for tech collaboration. Connect with freelancers, 
              discover events, and build communities in the Web3 era.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Button size="lg" className="glow-button text-lg px-8 py-3" asChild>
                <Link to="/freelance">Explore Gigs</Link>
              </Button>
              <Button size="lg" variant="outline" className="glass-effect text-lg px-8 py-3" asChild>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-background to-background/50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Powerful Features for Tech Professionals</h2>
        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-muted-foreground">Discover high-quality projects from top clients</p>
            </div>
            ...
            {featuredGigs.map((gig) => (
              ...
              >
                <CardHeader>
                  ...
                  <p className="text-2xl font-bold text-gradient">{gig.budget}</p>
                </CardHeader>
                <CardContent>
        ...
        <div className="container mx-auto">
          <div className="flex justify-between items-center mb-12">
            <div>
              ...
              <p className="text-muted-foreground">Join the tech community at these amazing events</p>
            </div>
            <Button variant="outline" asChild>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Join thousands of tech professionals who are already building their future on SparkVerse
            </p>
